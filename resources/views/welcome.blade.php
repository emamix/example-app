...
<body class="bg-gray-900">
    ...
    <div  class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center" id="modal-id">
        <div class="relative my-6 mx-auto w-80">
            <!--content-->
            <div  class="border-0 rounded shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div class="relative p-3 flex-auto">
                    ...
                    <div class="relative text-center">
                        <label for="customRange3" id="hour_label" class="form-label">SELECT HOUR</label>
                        <input
                            type="range"
                            onmouseup="toggleModal('modal-id')" 
                            class="mt-5 w-full h-1 bg-sky-600 rounded-lg appearance-none cursor-pointer bg-gray-light"
                            min="0"
                            max="47"
                            step="1"
                            ontouchend="toggleModal('modal-id')"
                            oninput="updateClockIn(value)"
                            id="customRange3"
                        />
                    </div>
                </div>
    ...
    <script type="text/javascript">
        let currentHourInput;
        let times = ["12:00 AM", "12:30 AM","1:00 AM", "1:30 AM","2:00 AM", "2:30 AM","3:00 AM", "3:30 AM","4:00 AM", "4:30 AM","5:00 AM", "5:30 AM","6:00 AM", "6:30 AM","7:00 AM", "7:30 AM","8:00 AM", "8:30 AM","9:00 AM", "9:30 AM","10:00 AM", "10:30 AM","11:00 AM", "11:30 AM",
        ...
        function updateClockIn(value)
        {
            document.getElementById("hour_label").innerHTML =  inOrOut(currentHourInput) + "<strong>" + times[value] + "</strong>";
            document.getElementById(currentHourInput).value = times[value];
        }
        ...
        function updateSliderValues(id)
        {
            if(id)
            {
                let val = document.getElementById(id).value;
                document.getElementById("hour_label").innerHTML = inOrOut(id) + "<strong>" + val + "</strong>";
                document.getElementById("customRange3").value = times.indexOf(val);
            }
        }
        ...
        {
            let val = document.getElementById(id).value;
            let inOrOut = (id == "clock_in") ? "Clock-in " : "Clock-out ";
            return inOrOut;
        }
    </script>
...
<script>
const range = new RangeTouch('input[type="range"]', {thumbWidth:30});
</script>
